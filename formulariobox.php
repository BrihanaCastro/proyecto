...
<section>
    <h2>De la Historia</h2>
    <div class="galeria">
        <div class="item">
            <img src="/BrihanaCastroo/menudespegable/Sugar.jpeg"  class="mostrar-imagen">
            <div class="texto-imagen">Sugar Ray Robinson</div>
        </div>
        <div class="item">
            <img src="/BrihanaCastroo/menudespegable/Mahama.jpeg" alt="Boxeador 2" class="mostrar-imagen">
            <div class="texto-imagen">Muhammad Ali</div>
        </div>
        <div class="item">
            <img src="/BrihanaCastroo/menudespegable/Chavez.jpeg" alt="Boxeador 3" class="mostrar-imagen">
            <div class="texto-imagen">Julio César Chávez</div>
        </div>
    </div>
    ...
    <div class="galeria">
        <div class="item">
            <img src="/BrihanaCastroo/menudespegable/Canelo.jpeg" alt="Boxeador 1" class="mostrar-imagen">
            <div class="texto-imagen">Canelo Alvarez</div>
        </div>
        <div class="item">
            <img src="/BrihanaCastroo/menudespegable/terence.jpeg" alt="Boxeador 2" class="mostrar-imagen">
            <div class="texto-imagen">Terence Crawford</div>
        </div>
        <div class="item">
            <img src="/BrihanaCastroo/menudespegable/coreanillo.jpeg" alt="Boxeador 3" class="mostrar-imagen">
            <div class="texto-imagen">Naoya Inoue</div>
        </div>
    </div>
</section>
<footer>
